...
class UpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'room_types.*.id' => ['nullable', 'integer', 'distinct', Rule::exists('room_types', 'id')->where('building_id', $buildingId)],
            ...
            'delete_room_type_ids' => ['nullable', 'array', 'max:100'],
            'delete_room_type_ids.*' => ['required', 'integer', 'distinct', Rule::exists('room_types', 'id')->where('building_id', $buildingId)],
            ...
            'asset_templates.*.id' => ['nullable', 'integer', 'distinct', Rule::exists('asset_templates', 'id')->where('building_id', $buildingId)],
            ...
            'delete_asset_template_ids' => ['nullable', 'array', 'max:100'],
            'delete_asset_template_ids.*' => ['required', 'integer', 'distinct', Rule::exists('asset_templates', 'id')->where('building_id', $buildingId)],
    ...
    public function messages(): array
    {
        return [
            ...
            'room_types.*.id.integer' => 'ID loại phòng không hợp lệ.',
            'room_types.*.id.distinct' => 'Danh sách loại phòng không được trùng ID.',
            'room_types.*.id.exists' => 'Loại phòng không tồn tại trong tòa nhà này.',
            ...
            'delete_room_type_ids.array' => 'Danh sách loại phòng cần xóa không hợp lệ.',
            'delete_room_type_ids.max' => 'Mỗi lần chỉ được xóa tối đa 100 loại phòng.',
            'delete_room_type_ids.*.required' => 'ID loại phòng cần xóa là bắt buộc.',
            'delete_room_type_ids.*.integer' => 'ID loại phòng cần xóa không hợp lệ.',
            'delete_room_type_ids.*.distinct' => 'Danh sách loại phòng cần xóa không được trùng lặp.',
            'delete_room_type_ids.*.exists' => 'Loại phòng cần xóa không tồn tại trong tòa nhà này.',
            ...
            'asset_templates.*.id.integer' => 'ID mẫu tài sản không hợp lệ.',
            'asset_templates.*.id.distinct' => 'Danh sách mẫu tài sản không được trùng ID.',
            'asset_templates.*.id.exists' => 'Mẫu tài sản không tồn tại trong tòa nhà này.',
            ...
            'delete_asset_template_ids.array' => 'Danh sách mẫu tài sản cần xóa không hợp lệ.',
            'delete_asset_template_ids.max' => 'Mỗi lần chỉ được xóa tối đa 100 mẫu tài sản.',
            'delete_asset_template_ids.*.required' => 'ID mẫu tài sản cần xóa là bắt buộc.',
            'delete_asset_template_ids.*.integer' => 'ID mẫu tài sản cần xóa không hợp lệ.',
            'delete_asset_template_ids.*.distinct' => 'Danh sách mẫu tài sản cần xóa không được trùng lặp.',
            'delete_asset_template_ids.*.exists' => 'Mẫu tài sản cần xóa không tồn tại trong tòa nhà này.',
