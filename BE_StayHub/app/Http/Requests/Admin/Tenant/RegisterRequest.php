...
class RegisterRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'username' => ['required', 'string', 'alpha_dash', 'min:3', 'max:20', Rule::unique('tenants', 'username')],
            'password' => ['prohibited'],
    ...
    public function messages(): array
    {
        return [
            ...
            'username.alpha_dash' => 'Tên đăng nhập khách thuê chỉ được chứa chữ cái, chữ số, dấu gạch ngang và dấu gạch dưới.',
            'username.min' => 'Tên đăng nhập khách thuê phải có ít nhất 3 ký tự.',
            'username.max' => 'Tên đăng nhập khách thuê không được vượt quá 20 ký tự.',
