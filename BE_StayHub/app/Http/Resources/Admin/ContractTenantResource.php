    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'tenant' => $this->whenLoaded('tenant', fn () => [
                ...
                'identity_date' => $this->tenant?->identity_date ? $this->tenant->identity_date->toDateString() : null,
                'identity_place' => $this->tenant?->identity_place,
                'permanent_address' => $this->tenant?->permanent_address,
                'gender' => $this->tenant?->gender,
                'date_of_birth' => $this->tenant?->date_of_birth ? $this->tenant->date_of_birth->toDateString() : null,
