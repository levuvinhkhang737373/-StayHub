...
class SecurityCameraResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'monitoring_started_at' => optional($this->monitoring_started_at)->toDateTimeString(),
            'monitoring_stopped_at' => optional($this->monitoring_stopped_at)->toDateTimeString(),
            'last_scanned_at' => optional($this->last_scanned_at)->toDateTimeString(),
            'next_scan_at' => optional($this->next_scan_at)->toDateTimeString(),
            'last_scan_status' => $this->last_scan_status,
            'last_scan_message' => $this->last_scan_message,
            'monitoring_error_count' => (int) $this->monitoring_error_count,
