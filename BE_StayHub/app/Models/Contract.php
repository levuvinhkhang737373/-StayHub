...
class Contract extends Model
{
    ...
    protected $fillable = ['contract_code', 'room_id', 'start_date', 'end_date', 'actual_end_date', 'room_price', 'deposit_amount', 'status', 'payment_status', 'contract_files', 'note', 'created_by', 'representative_tenant_id', 'parent_contract_id', 'renew_from_contract_id', 'tenant_signed_at', 'tenant_signature_url'];
