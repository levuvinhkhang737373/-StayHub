...
import { ArrowLeft, Car, Bike, Fuel, Zap, Edit3, Eye, Plus, RefreshCw, Search, Trash2, X } from 'lucide-react'
          ...
          <div className="relative p-4 text-[#fff4df] sm:p-5 lg:p-6">
            ...
            <div className="relative flex min-w-0 flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
              <div className="min-w-0">
                ...
                <h1 className="mt-3 max-w-3xl text-3xl font-black tracking-[-0.05em] text-[#fff4df] sm:text-4xl lg:text-[2.65rem]">Bãi xe & Phương tiện</h1>
              </div>
